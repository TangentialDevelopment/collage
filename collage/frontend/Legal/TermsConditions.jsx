...
const Terms = () => {
    return (
        <div className="content">
            ...
            <p className="subtitle">Acceptance of the Terms of Use</p>
            <p>These terms of use are entered into by and between you and [COMPANY NAME] (<span className="bold">"Company"</span> or <span className="bold">"We"</span>). The following terms and conditions[, together with any documents they expressly incorporate by reference] ([collectively, ] <span className="bold">"Terms of Use"</span>)[,] govern your access to and use of [WEBSITE DOMAIN NAME], including any content, functionality, and services offered on or through [WEBSITE DOMAIN NAME] (the <span className="bold">"Website"</span>)[, whether as a guest or a registered user].</p>
            <p>Please read the Terms of Use carefully before you start to use the Website. <span className="bold">By using the Website [or by clicking to accept or agree to the Terms of Use when this option is made available to you], you accept and agree to be bound and abide by these Terms of Use[ and our Privacy Policy, found at [PRIVACY POLICY URL], incorporated herein by reference]</span>. If you do not want to agree to these Terms of Use[ or the Privacy Policy], you must not access or use the Website. </p>
            ...
            <p className="subtitle">Changes to the Terms of Use</p>
            <p>We may revise and update these Terms of Use from time to time in our sole discretion. All changes are effective immediately when we post them[, and apply to all access to and use of the Website thereafter]. [However, any changes to the dispute resolution provisions set out in <a href="#law">Governing Law and Jurisdiction</a> will not apply to any disputes for which the parties have actual notice [on or] before the date the change is posted on the Website.] </p>
            ...
            <p className="subtitle">Accessing the Website and Account Security</p>
            ...
            <p className="subtitle">Intellectual Property Rights</p>
            ...
            <ul>
                ...
                <li>
                    <p>If we provide social media features [LINK TO THE WEBSITE AND SOCIAL MEDIA FEATURES] with certain content, you may take such actions as are enabled by such features.</p>
                </li>
            </ul>
            <p>You must not:</p>
            <ul>
            ...
            <p>[If you wish to make any use of material on the Website other than that set out in this section, please address your request to: [EMAIL ADDRESS].]</p>
            ...
            <ul>
                ...
                <li>
                    <p>To send, knowingly receive, upload, download, use, or re-use any material that does not comply with the Content Standards [LINK TO CONTENT STANDARDS] set out in these Terms of Use.</p>
                </li>
                <li>
                    <p>To transmit, or procure the sending of, any advertising or promotional material [without our prior written consent], including any "junk mail," "chain letter," "spam," or any other similar solicitation.</p>
                </li>
                <li>
                    <p>To impersonate or attempt to impersonate the Company, a Company employee, another user, or any other person or entity (including, without limitation, by using email addresses [or screen names] associated with any of the foregoing).</p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>
                    <p>Use any manual process to monitor or copy any of the material on the Website, or for any other purpose not expressly authorized in these Terms of Use, without our prior written consent.</p>
                </li>
                <li>
            ...
            <p className="subtitle">User Contributions</p>
            <p>The Website may contain message boards, chat rooms, personal web pages or profiles, forums, bulletin boards[, [OTHER INTERACTIVE FEATURES]], and other interactive features (collectively, <span className="bold">"Interactive Services"</span>) that allow users to post, submit, publish, display, or transmit to other users or other persons (hereinafter, <span className="bold">"post"</span>) content or materials (collectively, <span className="bold">"User Contributions"</span>) on or through the Website.</p>
            ...
            <ul>
                <li>
                    <p>You own or control all rights in and to the User Contributions and have the right to grant the license granted above to us and [our affiliates and service providers, and each of their and] our [respective] licensees, successors, and assigns.</p>
                </li>
                <li>
            ...
            <p className="subtitle">Monitoring and Enforcement; Termination</p>
            <p>v</p>
            <ul>
                <li>
                ...
                <li>
                    <p>Take appropriate legal action, including without limitation, referral to law enforcement, for any illegal or unauthorized use of the Website. </p>
                </li>
                <li>
                    <p>Terminate or suspend your access to all or part of the Website for [any or no reason, including without limitation,] any violation of these Terms of Use.</p>
                </li>
            </ul>
            ...
            <p className="subtitle">Content Standards</p>
            ...
            <p className="subtitle">Copyright Infringement</p>
            <p>If you believe that any User Contributions violate your copyright, please see our Copyright Policy [LINK TO COPYRIGHT POLICY] for instructions on sending us a notice of copyright infringement. It is the policy of the Company to terminate the user accounts of repeat infringers. </p>
            <p className="subtitle">Reliance on Information Posted</p>
            <p>he information presented on or through the Website is made available solely for general information purposes. We do not warrant the accuracy, completeness, or usefulness of this information. Any reliance you place on such information is strictly at your own risk. We disclaim all liability and responsibility arising from any reliance placed on such materials by you or any other visitor to the Website, or by anyone who may be informed of any of its contents.</p>
            ...
            <p className="subtitle">Changes to the Website</p>
            ...
            <p className="subtitle">Information About You and Your Visits to the Website</p>
            <p>All information we collect on this Website is subject to our Privacy Policy [LINK TO PRIVACY POLICY]. By using the Website, you consent to all actions taken by us with respect to your information in compliance with the Privacy Policy. </p>
            <p className="subtitle">[Online Purchases and Other Terms and Conditions</p>
            <p>All purchases through our site or other transactions for the sale of [goods][,/ or][services][,] [or][information] carried out through the Website, or resulting from visits made by you, are governed by our Terms of Sale [LINK TO TERMS OF SALE], which are hereby incorporated into these Terms of Use.</p>
            ...
            <p className="subtitle">Linking to the Website and Social Media Features</p>
            ...
            <ul>
                ...
                <li>
                    <p>Send emails or other communications with certain content, or links to certain content, on this Website.</p>
                </li>
                <li>
                    <p>Cause limited portions of content on this Website to be displayed or appear to be displayed on your own or certain third-party websites.</p>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <p>Cause the Website or portions of it to be displayed on, or appear to be displayed by, any other site, for example, framing, deep linking, or in-line linking.</p>
                </li>
                <li>
                    <p>Link to any part of the Website other than the homepage.</p>
                </li>
                <li>
                    <p>Otherwise take any action with respect to the materials on this Website that is inconsistent with any other provision of these Terms of Use.</p>
                </li>
            </ul>
            ...
            <p className="subtitle">Links from the Website</p>
            ...
            <p>TO THE FULLEST EXTENT PROVIDED BY LAW, IN NO EVENT WILL THE COLLECTIVE LIABILITY OF THE COMPANY AND ITS SUBSIDIARIES AND AFFILIATES, AND THEIR LICENSORS, SERVICE PROVIDERS, EMPLOYEES, AGENTS, OFFICERS, AND DIRECTORS, TO ANY PARTY (REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, OR OTHERWISE) EXCEED [[$NUMBER]/[THE GREATER OF [$NUMBER] OR THE AMOUNT YOU HAVE PAID TO THE COMPANY [IN THE LAST [NUMBER] MONTHS] FOR THE APPLICABLE [CONTENT[,]] [OR] [PRODUCT[,]] [OR] [SERVICE] OUT OF WHICH LIABILITY AROSE.</p>
            <p>The limitation of liability set out above does not apply to liability resulting from our gross negligence or willful misconduct [or death or bodily injury caused by products you purchase through the site].]</p>
            ...
            <p className="subtitle" id='law'>Governing Law and Jurisdiction</p>
            <p>All matters relating to the Website and these Terms of Use, and any dispute or claim arising therefrom or related thereto (in each case, including non-contractual disputes or claims), shall be governed by and construed in accordance with the internal laws of the State of [RELEVANT STATE] without giving effect to any choice or conflict of law provision or rule (whether of the State of [RELEVANT STATE] or any other jurisdiction).</p>
            ...
            <p className="subtitle">[Arbitration</p>
            <p>At Company's sole discretion, it may require you to submit any disputes arising from these Terms of Use or use of the Website, including disputes arising from or concerning their interpretation, violation, invalidity, non-performance, or termination, to final and binding arbitration under the Rules of Arbitration of the American Arbitration Association applying [RELEVANT STATE] law.]</p>
            <p className="subtitle">[Limitation on Time to File Claims</p>
            ...
            <p className="subtitle">Waiver and Severability</p>
            ...
            <p className="subtitle">Entire Agreement</p>
            <p>The Terms of Use[, /and] our Privacy Policy[,]] [and] [Terms of Sale[,]] [and] [LIST OTHER RELEVANT DOCUMENTS OR POLICIES]] constitute the sole and entire agreement between you and [COMPANY NAME] regarding the Website and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Website. </p>
            <p className="subtitle">Your Comments and Concerns</p>
            <p>This website is operated by [COMPANY NAME] [COMPANY ADDRESS].</p>
            <p>All notices of copyright infringement claims should be sent to the copyright agent designated in our Copyright Policy [LINK TO COPYRIGHT POLICY] in the manner and by the means set out therein.</p>
            <p>All other feedback, comments, requests for technical support, and other communications relating to the Website should be directed to: [EMAIL ADDRESS].</p>
        </div>
    )
}
